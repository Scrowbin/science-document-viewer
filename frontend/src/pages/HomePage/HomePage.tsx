...
import { FaCheck, FaRightFromBracket, FaUserPlus, FaChevronDown, FaArrowRightToBracket } from 'react-icons/fa6';
...
export function HomePage() {
  ...
  const handleCreateNewDocument = useCallback(() => {
    ...
    showToast('Ready to import document');
  }, [showToast]);
  ...
  return (
    <div className={styles.appContainer}>
      {/* 1. Browser-like Tab Bar + User Header Section */}
      <div className={styles.topBarWrapper}>
        ...
        <div className={styles.userHeaderSection} ref={userMenuRef}>
